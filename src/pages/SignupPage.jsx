/**
 * Signup Page component - Minimal Thinkific style
 */
    ...
    <div className="min-h-screen bg-white flex items-center justify-center py-12 md:py-16 px-4 -mt-16 pt-36 md:-mt-20 md:pt-40">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-gray-600 text-base">Start your Arabic learning journey today</p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="firstName" className="block text-sm font-bold text-font-primary mb-2">
                  First name
                </label>
                <input
                  id="firstName"
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm font-bold text-font-primary mb-2">
                  Last name
                </label>
                <input
                  id="lastName"
